...
class HelixUltimateFeatureMobile
{
	...
	public function renderFeature()
	{
		...
		if ($this->params->get('mobile_logo')) {
			...
			$logo_init .= '<img' . $image_mobile_width . $image_mobile_height . ' class="tm-mobile-logo" src="' . $this->params->get('mobile_logo') . '" alt="' . strip_tags($altText) . '" />';
			$logo_init .= '</a>';
		} elseif ($logo_desktop) {
			...
			if ($this->params->get('logo_image')) {
				...
				$logo_init .= '<img' . $logo_width . $logo_height . ' class="tm-logo" src="' . $this->params->get('logo_image') . '" alt="' . strip_tags($altText) . '" />';

...
<form action="<?php echo JURI::root(true); ?>/index.php" enctype="multipart/form-data" method="post" name="userform" autocomplete="off" class="form-validate">
    ...
    <?php endif; ?>
    <div id="k2Container" class="tm-k2AccountPage">
        <table class="uk-table uk-table-middle uk-table-justify" cellpadding="0" cellspacing="0">
            <tr>
                <th colspan="2" class="uk-heading-bullet">
                    <?php echo JText::_('K2_ACCOUNT_DETAILS'); ?>
                </th>
            </tr>
            <tr>
                <td class="key uk-width-medium">
                    <label class="uk-form-label" for="username"><?php echo JText::_('K2_USER_NAME'); ?></label>
                </td>
                <td>
            ...
            <tr>
                <td class="key uk-width-medium">
                    <label id="namemsg" class="uk-form-label" for="name"><?php echo JText::_('K2_NAME'); ?></label>
                </td>
                <td>
            ...
            <tr>
                <td class="key uk-width-medium">
                    <label id="emailmsg" class="uk-form-label" for="email"><?php echo JText::_('K2_EMAIL'); ?></label>
                </td>
                <td>
            ...
            <?php if (version_compare(JVERSION, '2.5', 'ge')) : ?>
                <tr>
                    <td class="key uk-width-medium">
                        <label id="email2msg" class="uk-form-label" for="email2"><?php echo JText::_('K2_CONFIRM_EMAIL'); ?></label>
                    </td>
                    <td>
                        <input type="text" id="email2" name="jform[email2]" size="40" value="<?php echo $this->escape($this->user->get('email')); ?>" class="uk-input required validate-email" maxlength="100" />
                    </td>
                </tr>
            <?php endif; ?>
            <tr>
                <td class="key uk-width-medium">
                    <label id="pwmsg" class="uk-form-label" for="password"><?php echo JText::_('K2_PASSWORD'); ?></label>
                </td>
                <td>
                    <input class="uk-input validate-password" type="password" id="password" name="<?php echo $this->passwordFieldName; ?>" size="40" value="" />
                </td>
            </tr>
            <tr>
                <td class="key uk-width-medium">
                    <label id="pw2msg" class="uk-form-label" for="password2"><?php echo JText::_('K2_VERIFY_PASSWORD'); ?></label>
                </td>
                <td>
                    <input class="uk-input validate-passverify" type="password" id="password2" name="<?php echo $this->passwordVerifyFieldName; ?>" size="40" value="" />
                </td>
            </tr>
            <tr>
                <th colspan="2" class="uk-heading-bullet">
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php if ($this->K2User->image) : ?>
                        ...
                        <label for="del_image">
                            <input class="uk-checkbox" type="checkbox" name="del_image" id="del_image" />
            ...
            <tr>
                ...
                <td>
                    <input class="uk-input" type="text" size="50" value="<?php echo $this->K2User->url; ?>" name="url" id="url" />
                </td>
            </tr>
        ...
        <div class="k2AccountPageUpdate">
            <button class="uk-button uk-button-primary validate" type="submit" onclick="submitbutton( this.form );return false;">

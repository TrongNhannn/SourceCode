...
if (!empty($visibleLists)) {
    ...
    foreach ($visibleLists as $myListId) {
        ...
        $listsContent .= '
                <tr>
                    <td>
                    	<input type="checkbox" class="uk-checkbox" name="subscription[]" id="acylist_'.$myListId.'_'.$formName.'" '.$check.' value="'.$myListId.'"/>
...
<table class="tm-acym-form uk-table<?php if (!$displayInline) { echo " uk-table-small" ; } else { echo " uk-margin-remove-bottom"; } ?> uk-table-justify">
	<tr>
        <?php

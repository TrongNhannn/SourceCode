...
<div id="article-<?php echo $this->item->id; ?>" class="uk-article<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Article">
	<meta class="uk-margin-remove-adjacent" itemprop="inLanguage" content="<?php echo ($this->item->language === '*') ? JFactory::getConfig()->get('language') : $this->item->language; ?>" />
			...
			<?php if (isset($this->item->toc)) :
				echo $this->item->toc;
					...
					<?php if ($params->get('show_tags', 1) && !empty($this->item->tags->itemTags)) : ?>
						...
						<p<?php echo $tag_cls; ?>><span class="uk-text-small uk-text-muted uk-margin-small-right"><i class="fas fa-tags"></i></span><?php echo $this->item->tagLayout->render($this->item->tags->itemTags); ?></p>
					<?php endif; ?>

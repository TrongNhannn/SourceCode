...
<?php if ($this->params->get('filter_field') !== 'hide' || $this->params->get('show_pagination_limit')) : ?>
	...
	<div class="control-group hide pull-right">
		<div class="controls">
			<button type="submit" name="filter_submit" class="uk-button uk-button-primary"><?php echo JText::_('COM_CONTENT_FORM_FILTER_SUBMIT'); ?></button>
		</div>
	</div>
...
<?php if (empty($this->items)) : ?>
	...
	<?php endif; ?>
<?php else : ?>
	<table class="category uk-table uk-table-justify uk-table-divider<?php echo $tableClass; ?>">
